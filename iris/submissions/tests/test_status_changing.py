...
#R: 19, 0: Too many public methods (21/20) (too-many-public-methods)
#C:160, 4: Invalid method name "test_package_two_failed_and_then_one_succeed" (invalid-name)
...
class StatusTest(TestCase):
    ...
    def test_package_succeed(self):
        ...
        self.assertEquals(
            '10_PKGBUILDING',
            self.submission(tag=self.tag, gitpath=self.gitpath).status)
