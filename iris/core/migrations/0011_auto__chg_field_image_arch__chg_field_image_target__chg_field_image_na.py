...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.arch'
        db.alter_column(u'core_image', 'arch', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Image.target'
        db.alter_column(u'core_image', 'target', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Image.name'
        db.alter_column(u'core_image', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding unique constraint on 'Image', fields ['name', 'target', 'product']
        db.create_unique(u'core_image', ['name', 'target', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Image', fields ['name', 'target', 'product']
        db.delete_unique(u'core_image', ['name', 'target', 'product_id'])


        # Changing field 'Image.arch'
        db.alter_column(u'core_image', 'arch', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Image.target'
        db.alter_column(u'core_image', 'target', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Image.name'
        db.alter_column(u'core_image', 'name', self.gf('django.db.models.fields.TextField')())
