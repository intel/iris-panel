...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_snapshot', (
            ...
            ('daily_url', self.gf('django.db.models.fields.URLField')(db_index=True, max_length=512, null=True, blank=True)),
            ('weekly_url', self.gf('django.db.models.fields.URLField')(db_index=True, max_length=512, null=True, blank=True)),
        ))
