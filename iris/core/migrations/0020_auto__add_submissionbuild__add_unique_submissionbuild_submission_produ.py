...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubmissionBuild'
        db.create_table(u'core_submissionbuild', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Submission'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Product'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BuildGroup'])),
        ))
        db.send_create_signal('core', ['SubmissionBuild'])

        # Adding unique constraint on 'SubmissionBuild', fields ['submission', 'product']
        db.create_unique(u'core_submissionbuild', ['submission_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SubmissionBuild', fields ['submission', 'product']
        db.delete_unique(u'core_submissionbuild', ['submission_id', 'product_id'])

        # Deleting model 'SubmissionBuild'
        db.delete_table(u'core_submissionbuild')
