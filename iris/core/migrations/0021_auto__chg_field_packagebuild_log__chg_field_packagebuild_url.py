...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_packagebuild', 'url', self.gf('django.db.models.fields.URLField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'PackageBuild.log'
        db.alter_column(u'core_packagebuild', 'log', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'PackageBuild.url'
        db.alter_column(u'core_packagebuild', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
