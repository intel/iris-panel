...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImageBuild.url'
        db.alter_column(u'core_imagebuild', 'url', self.gf('django.db.models.fields.URLField')(max_length=512))

        # Changing field 'ImageBuild.log'
        db.alter_column(u'core_imagebuild', 'log', self.gf('django.db.models.fields.URLField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'ImageBuild.url'
        db.alter_column(u'core_imagebuild', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'ImageBuild.log'
        db.alter_column(u'core_imagebuild', 'log', self.gf('django.db.models.fields.URLField')(max_length=200))
