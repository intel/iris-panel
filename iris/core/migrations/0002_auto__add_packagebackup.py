...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PackageBackup'
        db.create_table(u'core_packagebackup', (
            ...
            ('isdel', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['PackageBackup'])


    def backwards(self, orm):
        # Deleting model 'PackageBackup'
        db.delete_table(u'core_packagebackup')
