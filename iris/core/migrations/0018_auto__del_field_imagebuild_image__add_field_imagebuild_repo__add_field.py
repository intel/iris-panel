...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImageBuild.image'
        db.delete_column(u'core_imagebuild', 'image_id')

        # Adding field 'ImageBuild.repo'
        db.add_column(u'core_imagebuild', 'repo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'ImageBuild.group'
        db.add_column(u'core_imagebuild', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.BuildGroup']),
                      keep_default=False)

        # Adding field 'ImageBuild.url'
        db.add_column(u'core_imagebuild', 'url',
        ...
        # Changing field 'ImageBuild.status'
        db.alter_column(u'core_imagebuild', 'status', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'ImageBuild.name'
        db.alter_column(u'core_imagebuild', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding index on 'ImageBuild', fields ['name']
        db.create_index(u'core_imagebuild', ['name'])

        # Adding unique constraint on 'ImageBuild', fields ['name', 'group']
        db.create_unique(u'core_imagebuild', ['name', 'group_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ImageBuild', fields ['name', 'group']
        db.delete_unique(u'core_imagebuild', ['name', 'group_id'])

        # Removing index on 'ImageBuild', fields ['name']
        db.delete_index(u'core_imagebuild', ['name'])

        # Adding field 'ImageBuild.image'
        db.add_column(u'core_imagebuild', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Image']),
                      keep_default=False)

        # Deleting field 'ImageBuild.repo'
        db.delete_column(u'core_imagebuild', 'repo')

        # Deleting field 'ImageBuild.group'
        db.delete_column(u'core_imagebuild', 'group_id')

        # Deleting field 'ImageBuild.url'
        db.delete_column(u'core_imagebuild', 'url')

        # Deleting field 'ImageBuild.log'
        db.delete_column(u'core_imagebuild', 'log')


        # Changing field 'ImageBuild.status'
        db.alter_column(u'core_imagebuild', 'status', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'ImageBuild.name'
        db.alter_column(u'core_imagebuild', 'name', self.gf('django.db.models.fields.TextField')())
